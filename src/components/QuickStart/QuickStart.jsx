    ...
    return (
        <div className="flex flex-col sm:flex-row items-center gap-4">
            {data.map((item, index) => (
                <div
                    key={index}
                    className="flex items-center gap-2 rounded-4xl bg-gray-800 text-white text-[12px] px-2 py-2 w-full sm:w-auto transition-all duration-300 hover:-translate-y-1"
                >
                    {item.icon}
